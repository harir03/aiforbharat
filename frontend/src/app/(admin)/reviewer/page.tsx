...
export default function ReviewerPage() {
  ...
  return (
    <>
      ...
      {isQueueEmpty && (
        <div
          className="flex flex-col items-center justify-center rounded-xl bg-white py-20
        ...
        >
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            The reviewer queue is empty. New cases will appear as they are
            detected.
          </p>
        </div>
      )}
      ...
      {!isLoading && activeCase && queue && (
        <div className="space-y-6">
          ...
          <QueueStatusBar
            total={queue.total}
            hasStale={queue.has_stale}
            staleCount={queue.stale_count}
          />

          {/* Two-column layout: 60% comparison / 40% evidence */}
